...
public class FrmCargo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtDescrip, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
        ...
        getAccessibleContext().setAccessibleName("Mantenimiento de Cargos");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String resp, nombre, descrip;
        nombre = txtNombre.getText();
        descrip = txtAreaDescrip.getText();
        if (nombre.length() == 0) {
            this.mensajeAdvertencia("Debes ingresar un nombre");
        }else if( descrip.length() == 0 ){
            this.mensajeAdvertencia("Debes ingresar una descripcion");
        }else {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (tablaListado.getSelectedRowCount() == 1) {
            ...
            String descrip = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(),2));
